...
# Add new arguments for CPU_CONFIG, CACHE_SWEEP, and ASSOCIATIVITY
parser.add_argument('--cpu_config', type=str, default='X86MinorCPU')
parser.add_argument('--cache_sweep', type=str, default='32kB')
...
# CPU Setup
cpu_class = globals()[args.cpu_config]
